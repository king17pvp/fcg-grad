"""
Benchmark Script for FCGGrad Attribution on Question Answering
...
def run_single_example(question, context, model_name,
    ...
    # eval_base_token_emb replaces res["base_token_emb"] from the result
...
def run_benchmark(args):
    ...
    if count > 0:
        print(f"\n{''*52}")
        print(f"FCGGrad QA  |  {args.model_name}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Benchmark FCGGrad Attribution for Question Answering"
    )
